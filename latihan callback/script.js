...
//   $.ajax({
//     url:
//       'http://www.omdbapi.com/?apikey=882e02af&s=' + $('.input-keyword').val(),
//     success: result => {
...
//       // ketika tombol detail dclick
//       $('.modal-detail-button').on('click', function () {
//         $.ajax({
//           url:
//             'http://www.omdbapi.com/?apikey=882e02af&i=' +
//             $(this).data('imdbid'),
//           success: m => {
...
//   fetch('http://www.omdbapi.com/?apikey=882e02af&s=' + inputKeyword.value)
